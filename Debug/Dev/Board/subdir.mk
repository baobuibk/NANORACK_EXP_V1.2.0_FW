...
Dev/Board/%.o Dev/Board/%.su Dev/Board/%.cyclo: ../Dev/Board/%.c Dev/Board/subdir.mk
...
clean: clean-Dev-2f-Board

clean-Dev-2f-Board:
	-$(RM) ./Dev/Board/board.cyclo ./Dev/Board/board.d ./Dev/Board/board.o ./Dev/Board/board.su

.PHONY: clean-Dev-2f-Board
