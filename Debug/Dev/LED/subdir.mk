...
C_SRCS += \
../Dev/LED/status_led.c 

OBJS += \
./Dev/LED/status_led.o 

C_DEPS += \
./Dev/LED/status_led.d 


# Each subdirectory must supply rules for building sources it contributes
Dev/LED/%.o Dev/LED/%.su Dev/LED/%.cyclo: ../Dev/LED/%.c Dev/LED/subdir.mk
...
clean: clean-Dev-2f-LED

clean-Dev-2f-LED:
	-$(RM) ./Dev/LED/status_led.cyclo ./Dev/LED/status_led.d ./Dev/LED/status_led.o ./Dev/LED/status_led.su

.PHONY: clean-Dev-2f-LED
