...
Dev/WDog/%.o Dev/WDog/%.su Dev/WDog/%.cyclo: ../Dev/WDog/%.c Dev/WDog/subdir.mk
...
clean: clean-Dev-2f-WDog

clean-Dev-2f-WDog:
	-$(RM) ./Dev/WDog/watchdog.cyclo ./Dev/WDog/watchdog.d ./Dev/WDog/watchdog.o ./Dev/WDog/watchdog.su

.PHONY: clean-Dev-2f-WDog
